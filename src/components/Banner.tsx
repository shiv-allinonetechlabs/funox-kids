    ...
    <section className="relative overflow-hidden">
      <div className="container">
        ...
        <div className="shadow-3xl border-glass-border from-primary/5 via-card-bg to-secondary/5 relative overflow-hidden rounded-[40px] border-6 bg-linear-to-br p-6 md:p-10 lg:p-12">
          ...
          <div className="bg-primary/20 absolute -top-24 -right-24 h-[400px] w-[400px] rounded-full blur-[80px]" />
          <div className="bg-secondary/20 absolute -bottom-24 -left-24 h-[400px] w-[400px] rounded-full blur-[80px]" />
          <div className="bg-primary/10 absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[100px]" />
          ...
          <div className="relative z-10 grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="relative flex items-center justify-center">
              <div className="group border-glass-border bg-glass-bg relative flex h-64 w-64 items-center justify-center rounded-3xl border-4 shadow-2xl backdrop-blur-xl transition-all duration-700 hover:scale-110 hover:rotate-3 sm:h-80 sm:w-80">
