      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 md:gap-6">
          <div className="relative">
            {/* Spinning Rings */}
            <div className="border-primary absolute -inset-2 animate-spin rounded-full border-3 border-t-transparent border-dashed opacity-40 md:-inset-4 md:border-4" />
            <div className="border-secondary absolute -inset-4 animate-spin-slow rounded-full border-3 border-b-transparent border-dashed opacity-30 md:-inset-8 md:border-4" />

            {/* Bouncing Character/Icon */}
            <div className="animate-bounce-slow flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-4xl shadow-xl shadow-primary/20 ring-4 ring-primary/10 md:h-20 md:w-20 md:rounded-3xl md:text-5xl">
